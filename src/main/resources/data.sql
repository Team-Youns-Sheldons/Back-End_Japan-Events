...
INSERT INTO event(id_event, name, capacity, price, description, ubication, time, date, types_id) VALUES(DEFAULT, "Festival de la nieve de Sapporo (Hokkaido)", 10000, 0, "El festival de la nieve de Sapporo (Sapporo Yuki Matsuri) es uno de los mayores festivales del año para la ciudad de Sapporo. Se celebra en febrero durante una semana desde 1950", "Sapporo", "07:00", "Febrero", 4);
